...
public class PhotoView extends View implements OnGestureListener,
    ...
    private void generateScale() {
        ...
        if (!isCenterCropScaleType && dwidth < vwidth && dheight < vheight && !mAllowCrop) {
            mMinScale = 1.0f;
        } else {
            mMinScale = getScale();
        }
    ...
    public boolean isCenterCropScaleType() {
        return isCenterCropScaleType;
    }

    public void setCenterCropScaleType(boolean centerCropScaleType) {
        isCenterCropScaleType = centerCropScaleType;
    }
